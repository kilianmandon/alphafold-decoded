...
class RecyclingEmbedder(nn.Module):
    ...
    def forward(self, m_prev, z_prev, x_prev):
        ...
        Args:
            m_prev (torch.tensor): MSA feature of previous iteration, shape (*, N_seq, N_res, c_m).
            z_prev (torch.tensor): Pair feature of previous iteration, shape (*, N_res, N_res, c_z).
        ...
        #   * d should have shape (*, N_res, N_res)                              #
