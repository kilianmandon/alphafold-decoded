...
def test_module(module, test_name, input_names, output_names, control_folder, overwrite_results=False):
    ...
    if overwrite_results:
        ...
        for out, out_name in zip(batched_out, out_file_names_batched):
            torch.save(out, out_name)
