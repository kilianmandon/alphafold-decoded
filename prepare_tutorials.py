...
# Example usage
inp_name = 'solutions/machine_learning_introduction/machine_learning_introduction.ipynb'
out_name = 'tutorials/machine_learning_introduction/machine_learning_introduction.ipynb'
